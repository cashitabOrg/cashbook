                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 block w-full rounded-md bg-white dark:bg-[#252528] border-gray-300 dark:border-[#3A3A3C] shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-3 py-2 border text-gray-900 dark:text-white no-spinner"
                    />
                  </div>
