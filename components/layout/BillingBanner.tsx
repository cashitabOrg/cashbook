...
export default function BillingBanner({
  ...
  if (isExempt) {
    return (
      <div className="relative w-full px-4 py-2 flex items-center justify-between text-[10px] font-black uppercase tracking-widest z-40 shadow-lg bg-indigo-600 text-white">
        ...
        <div className="flex items-center gap-3">
          ...
          <span>
            BETA / TESTING MODE —{" "}
            <span className="opacity-80 font-bold italic">
              Unlimited features enabled for testing. Billing will commence
              soon.
            </span>
          </span>
        </div>
  ...
  return (
    <div
      className={`relative w-full px-4 py-2 flex items-center justify-between text-[10px] font-black uppercase tracking-widest z-40 shadow-lg ${
        isExpired
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span>
          {isFree ? (
            <>
              Kiosk Mode (Free Plan) —{" "}
              <span className="opacity-70">
                Upgrade to Basic for ₦15k/mo to unlock full audit logs.
              </span>
            </>
          ) : isExpired ? (
            <>
              ...
              <span className="opacity-90">
                Sales and Product creation are currently locked.
              </span>
            </>
          ) : (
            <>
